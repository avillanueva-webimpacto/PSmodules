...
class UploadCsv extends Module
{
    public $hooks = array();
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Importador de archivos CSV');
        $this->description = $this->l('Tarea número 2 de Prestashop para webImpacto');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::getIsset('subirCSVImpApad')) {
            $target_dir = _PS_BASE_URL_.__PS_BASE_URI__."modules/uploadcsv/";
				...
				<div class="margin-form">
					<input type="file" name="archivocsimp_apad" />
                                        <a target="_blank" style="font-size: 14px;" 
                                         href="'._PS_BASE_URL_.__PS_BASE_URI__.'modules/uploadcsv/template.csv">
